...
- Name: login.spec.ts >> @P1 @Regression @Login Login Feature >> @P2 @Regression Login Page Elements >> should navigate to sign up page
- Location: src\tests\login.spec.ts:105:13
