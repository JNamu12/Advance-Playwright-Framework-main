...
- Name: login.spec.ts >> @P1 @Regression @Login Login Feature >> @P2 @Regression Login Page Elements >> should navigate to forgot password page
- Location: src\tests\login.spec.ts:99:13
