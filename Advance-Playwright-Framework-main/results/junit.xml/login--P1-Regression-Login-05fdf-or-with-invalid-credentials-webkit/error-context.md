...
- Name: login.spec.ts >> @P1 @Regression @Login Login Feature >> @P1 @Regression Invalid Login Scenarios >> should show error with invalid credentials
- Location: src\tests\login.spec.ts:46:13
