...
- Name: login.spec.ts >> @P1 @Regression @Login Login Feature >> @P0 @Smoke Valid Login Scenarios >> should login successfully with valid credentials
- Location: src\tests\login.spec.ts:18:13
